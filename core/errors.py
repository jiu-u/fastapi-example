...
UnprocessableEntity = new_error(
    status_code=422, code=422, message="Unprocessable Entity"
)
TooManyRequests = new_error(status_code=429, code=429, message="Too Many Requests")
InternalServerError = new_error(
    status_code=500, code=500, message="Internal Server Error"
)
